...
call runFastQC as firstMateFastQC { input: inputFastq = inputFastqs[0], modules = runFastQC_modules }
...
if (length(inputFastqs) > 1) {
 ...
 call runFastQC as secondMateFastQC { input: inputFastq = inputFastqs[1], modules = runFastQC_modules }
